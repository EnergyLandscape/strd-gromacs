...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwNone_GeomP1P1_VF_avx_128_fma_double
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecCoul_VdwNone_GeomP1P1_F_avx_128_fma_double
 * Electrostatics interaction: Coulomb
 * VdW interaction:            None
 * Geometry:                   Particle-Particle
