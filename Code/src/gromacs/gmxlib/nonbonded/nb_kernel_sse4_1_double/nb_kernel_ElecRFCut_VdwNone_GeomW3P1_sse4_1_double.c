...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwNone_GeomW3P1_VF_sse4_1_double
...
/*
 * Gromacs nonbonded kernel:   nb_kernel_ElecRFCut_VdwNone_GeomW3P1_F_sse4_1_double
 * Electrostatics interaction: ReactionField
 * VdW interaction:            None
 * Geometry:                   Water3-Particle
