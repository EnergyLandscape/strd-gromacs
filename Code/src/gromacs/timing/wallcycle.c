...
// ===================================================================
//SRDCODE added wallcycle names for SRD
...
static const char *wcn[ewcNR] =
{
    ...
    "Enforced rotation", "Add rot. forces", "Coordinate swapping", "IMD",
    "MPC - Init", "MPC - Cells", "MPC - Reduce Sums", "MPC - Comm. pt. 1", "MPC - Collisions", "MPC - Comm. pt. 2",
    "MPC - Output", "MPC - Comm. Test",  "Test"
};
